...
class Solution {
        public int strToInt(String str) {
            ...
            for (; index < chars.length; index++) {
                ...
                if (res > border || (res == border && curChar>'7')) { // Integer.MAX_VALUE 最后一位是7
...
//        int toInt = solution.strToInt("   2147483649sda  dad");
        int toInt = solution.strToInt("   -003649sda  dad");
